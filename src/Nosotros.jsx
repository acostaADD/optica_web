...
function Nosotros() {
  return (
    <div className="min-h-screen bg-white py-12 font-creato">
      <div className="max-w-6xl mx-auto px-6">
        {/* Encabezado Principal */}
        <div className="text-center mb-16">
          <h1 className="text-4xl md:text-5xl font-creato font-bold text-gray-900 mb-4">
            SOBRE NOSOTROS: EL PROPÓSITO DE POLICLÍNICO LAGOZ
          </h1>
          <div className="w-32 h-1 bg-[#057CCC] mx-auto mb-8"></div>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto font-creato">
        ...
        <section className="mb-20">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl font-creato font-bold text-gray-800 mb-6">Nuestra Historia: Una Visión que Nació del Compromiso</h2>
              
              <div className="mb-8">
                <h3 className="text-xl font-creato font-semibold text-[#057CCC] mb-4">La Fuerza del Origen</h3>
                <p className="text-gray-600 leading-relaxed mb-4 font-creato">
                  El origen de <strong className="font-creato font-bold">Policlínico Lagoz (RAFA LENS E.I.R.L.)</strong> se remonta al año 2001. 
                  Nuestra historia comenzó con una visión de vida impulsada por nuestro fundador, 
                  <strong className="font-creato font-bold"> Rafael Lavado Gómez</strong>, y la convicción de mejorar la calidad de vida de su entorno 
                  a través de la salud visual.
                </p>
                <p className="text-gray-600 leading-relaxed mb-4 font-creato">
                  Con solo <strong className="font-creato font-bold">S/ 700 ahorrados</strong>, dimos los primeros pasos como distribuidores, 
                  evolucionando hasta formalizar nuestra operación en <strong className="font-creato font-bold">septiembre de 2014</strong>. 
                  Esta determinación nos llevó a una expansión internacional para crear nuestras propias marcas, 
                  como <strong className="font-creato font-bold">Lagoz y Aosidi</strong>, asegurando productos de calidad alineados con estándares globales.
                </p>
                <p className="text-gray-600 leading-relaxed font-creato font-semibold">
        ...
        <section className="mb-20">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-creato font-bold text-gray-800 mb-4">Nuestra Cultura: Misión, Visión y Valores</h2>
            <p className="text-gray-600 max-w-3xl mx-auto font-creato">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
            ...
            <div className="bg-[#057CCC]/10 rounded-2xl p-8 border-l-4 border-[#057CCC]">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-2xl font-creato font-bold text-gray-800">Misión</h3>
              </div>
              <p className="text-gray-600 leading-relaxed font-creato">
            ...
            <div className="bg-green-50 rounded-2xl p-8 border-l-4 border-green-500">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-2xl font-creato font-bold text-gray-800">Visión</h3>
              </div>
              <p className="text-gray-600 leading-relaxed font-creato">
                Asegurar que las personas no solo <strong className="font-creato font-bold">"vean bien, sino que también se sientan bien"</strong>. 
          ...
          <div className="bg-gray-50 rounded-2xl p-8">
            <h3 className="text-3xl font-creato font-bold text-center text-gray-800 mb-8">Nuestros Valores</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                ...
                <div key={index} className="text-center p-6 bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow">
                  ...
                  <h4 className="text-xl font-creato font-bold text-gray-800 mb-3">{valor.title}</h4>
                  <p className="text-gray-600 text-sm font-creato">{valor.description}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <section className="mb-12">
          <div className="bg-gradient-to-r from-[#057CCC] to-[#046bb8] rounded-2xl p-8 text-white">
            <div className="text-center mb-6">
              <h2 className="text-3xl font-creato font-bold mb-2">Dónde Encontrarnos</h2>
              <p className="text-blue-100 font-creato">Servimos a la población de Huánuco y provincias aledañas</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              <div className="text-center md:text-left">
                <div className="flex items-center justify-center md:justify-start mb-4">
                  ...
                  <h3 className="text-xl font-creato font-bold">Huánuco (Policlínico)</h3>
                </div>
                <p className="text-lg font-creato">JR. Dos de Mayo - 1066 - Huánuco</p>
              </div>
              ...
              <div className="text-center">
                <div className="inline-flex items-center bg-white/20 px-4 py-2 rounded-lg">
                  ...
                  <span className="font-creato font-semibold">+51 914 610 769</span>
                </div>
              </div>
            </div>
          </div>
        ...
        {/* Línea de Tiempo */}
        <section className="mb-12">
          <h3 className="text-2xl font-creato font-bold text-center text-gray-800 mb-8">Nuestra Trayectoria</h3>
          <div className="flex flex-col md:flex-row justify-between items-center relative">
            ...
            {[
              ...
              <div key={index} className="relative z-10 text-center mb-8 md:mb-0">
                <div className="bg-[#057CCC] text-white w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-3 font-creato font-bold text-lg">
                  {item.year}
                </div>
                <p className="text-gray-700 font-creato font-semibold">{item.event}</p>
              </div>
            ))}
          </div>
        </section>
